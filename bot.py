...
API_TOKEN = "8471383666:AAH75KlVq2XPYqRd0JYbLuWB5yRUHM6oyWc"  # <-- Bot tokeningiz
...
# --- Vaqtincha saqlanadigan ma'lumotlar ---
uc_narxlar = "UC narxlari hali belgilanmagan."
malumot_video = None
akavideo = None


# --- Asosiy menyu (yonma-yon) ---
def main_menu():
    buttons = [
        [
...
async def set_akavideo_vid(message: types.Message, state: FSMContext):
    ...
    await message.answer("🎮 Akkaunt savdo videosi saqlandi!", reply_markup=admin_panel())
    await state.finish()
